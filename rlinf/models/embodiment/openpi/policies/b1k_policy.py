...
"""Behavior-1K policy transforms for data processing."""
...
def extract_state_from_proprio(proprio_data):
    """
    Extract state from proprioceptive data for R1Pro robot.
...
class B1kInputs(transforms.DataTransformFn):
    """Input transforms for Behavior-1K dataset."""
...
class B1kOutputs(transforms.DataTransformFn):
    """Output transforms for Behavior-1K dataset."""
